    ...
    <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl p-6">
      <div className="text-center mb-4">
        <h1 className="text-2xl font-bold text-gray-800">
          Experience the <br />
          <span className="text-blue-600">UAAC Difference</span>
        </h1>
      </div>
      
      <p className="text-gray-600 mb-6">
        Watch our video to discover what makes the Urological Association of Asia Congress the premier event for 
        urology professionals across the region.
      </p>
