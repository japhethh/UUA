    ...
    <div className="mt-15 max-md:mt-8">
      <div className="flex flex-col gap-3 ">
        <h1 className="text-4xl max-md:text-2xl font-semibold text-center leading-tight ">
          Experience the <br className="max-md:hidden" /> UAAC Difference
        </h1>
      ...
      <div className="mt-5 max-md:mt-4">
        <div className="bg-[#FAFAFA] rounded-[3rem] max-md:rounded-2xl w-full aspect-video flex flex-col justify-start items-start relative shadow-sm overflow-hidden">
          {showVideo ? (
            <video src="/root/experience-uaac.mp4" controls autoPlay className="absolute inset-0 w-full h-full object-cover rounded-[3rem] max-md:rounded-2xl" />
          ) : (
            <>
              <div className="pt-10 pl-10 max-md:pt-5 max-md:pl-4">
                <h2 className="text-lg max-md:text-base font-semibold text-black mb-1">UAA: Advancing Urological Excellence Across Asia</h2>
